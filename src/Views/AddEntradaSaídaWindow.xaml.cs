...
namespace WMS_RadiadoresLemos_WPF
{
    public partial class AddEntradaSaídaWindow : Window
    {
        ...
        private bool AtualizarCamposProduto(ProdutoData produto)
        {
            ...
            // Atualiza campos "Depois" com valores iniciais
            AtualizarCamposDepoisInicial(produto);
        ...
        private void AtualizarCamposDepoisInicial(ProdutoData produto)
        {
        ...
        private bool ProcessarAlteracoes(ProdutoData produto)
        {
            ...
            AtualizarCamposDepois(produto, quantidadeFinal, precoAlterado);
            return true;
        }
        ...
        private void AtualizarCamposDepois(ProdutoData produto, int quantidadeFinal, double precoAlterado)
        {
        ...
        // Método para animar o botão de toggle da lista
        ...
        // Método para excluir um item da lista de movimentações
